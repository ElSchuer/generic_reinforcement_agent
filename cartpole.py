...
agent = dqn_agent.DuelingDDQNAgent(state_size=env.state_size, action_size=env.action_size, model=model, learning_rate=0.002,
                                 queue_size=50000, batch_size=85, eps_decay=0.999, eps_min=0.05, decay_rate=0.95, update_steps=10000)
