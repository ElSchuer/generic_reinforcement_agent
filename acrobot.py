...
agent = dqn_agent.QLearningAgent(state_size=state_size, action_size=action_size, learning_rate=0.001, queue_size=100000,
                                 batch_mode=True, batch_size=500, eps_decay=0.999)
